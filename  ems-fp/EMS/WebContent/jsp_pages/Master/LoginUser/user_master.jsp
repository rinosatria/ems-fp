...
<head>
<base href="<%=basePath%>">
<title><%= resource1.getString("employee_management") %>....<%= resource1.getString("title_user") %></title>
...
<body>
		...
		<form class="login active">
					...
					<table width="397" height="116" align="center">
						...
						<tr>
							<td><label>
							  <div align="center"><%= resource1.getString("users_master") %> :</div>
							</label></td>
							<td><div align="center">
							  <input type="text" onKeyPress="return change(this,event);" />
						    </div></td>
						...
						<tr>							
							<td><label>
							  <div align="center"><%= resource.getString("password") %> :</div>
							</label></td>
							<td><div align="center">
							  <input	onkeypress="return change(this,event);" type="password" />
						    </div></td>
						</tr>
						<tr>
							<td><label>
