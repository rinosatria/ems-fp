...
<head>
<base href="<%=basePath%>">
<title><%= resource1.getString("employee_management") %>....<%= resource1.getString("title_qt") %></title>
...
<body>
		...
		<form class="login active">
					...
					<table width="397" height="116" align="center">
						...
						<tr>
							<td><label>
							  <div align="center"><%= resource1.getString("category_select") %> :</div>
							</label></td>
							<td><div align="center">
							  <input type="text" onKeyPress="return change(this,event);" />
						    </div></td>
						...
						<tr>
							<td><label>
							  <div align="center"><%= resource1.getString("qt_name") %> :</div>
							</label></td>
							<td><div align="center">
							  <input type="text" onKeyPress="return change(this,event);" />
						    </div></td>
